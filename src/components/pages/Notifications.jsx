...
function Notifications() {
  ...
  const handleSelectAll = () => {
    ...
    employees.forEach((employee) => {
      updateSelection[employee.id] = !selectAll;
    });
    setSelctedEmployee(updateSelection);
  };

  const handleEmployeeSelection = (id, employeeName, employeeId, document) => {
    setSelctedEmployee((prevState) => ({
      ...prevState,
      [id]: !prevState[id],
    }));
    alert(
  ...
  const isAllSelected = employees.every(
